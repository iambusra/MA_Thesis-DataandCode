...
n_estimators = 103 # number of trees in the forest
max_depth = None # maximum depth of each tree
random_state = 42 # random seed for reproducibility
class_weight = 'balanced_subsample' # balance classes for each tree
min_samples_leaf = 5
weigth_1 = np.count_nonzero(train_y == 1)/len(train_y)
weigth_0 = 1-weigth_1
class_weight = {0:weigth_0, 1:weigth_1}

print("weigths", weigth_1, weigth_0)
...
np.save('pred_y_skrf.npy', pred_y)
